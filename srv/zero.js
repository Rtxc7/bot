...
var { gempa } = require('../mess/scraper')
...
var num = "67579764981@s.whatsapp.net"
var ownerNumber = ["67579764981@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
...
surface : 1,
message: `Felix Bot`, 
orderTitle: `Sewa Bot 15k Perbulan`,
thumbnail: fakethumb,
...
case 'menu':
case 'help':
 menu = `Halo Kak!\nSaya Felix, Bot WhatsApp yg membantu kamu untuk mempermudah sesuatu seperti Membuat Sticker dan Lainnya, Ada Butuh Info Dariku?`
 but = [
                { buttonId: 'command', buttonText: { displayText: 'COMMAND' }, type: 1 },
                { buttonId: 's&k', buttonText: { displayText: 'S&K' }, type: 1 }
                 ]
sendButLocation(from, menu, "Note: Jika Button Tidak Keliatan Bisa Lihat Di Youtube!!", fakeimg, but, zer)
break
case 'command':
...
🌹OWNER MENU 🌹
 ...
 ➤ ${prefix}bc all media with caption
 ➤ ${prefix}delchat
 ➤ ${prefix}mute
 ➤ ${prefix}unmute
 ...
 ➤ ${prefix}upswimage image and caption
 ➤ ${prefix}upswgif  gif and caption
 ➤ ${prefix}upswvideo vidio and caption
 ➤ ${prefix}shutdown
 ➤ ${prefix}offline
 ➤ ${prefix}online
...
sendButLocation(from, menu, "Felix Chan V2", fakeimg, but, zer)
break
case 'downloadmenu':
menu = `
🌹 DOWNLOADER MENU 🌹
...
➤ ${prefix}brainly search
➤ ${prefix}igstalk link
➤ ${prefix}twitter link
➤ ${prefix}twmp3 link
➤ ${prefix}linkwa search
➤ ${prefix}fb link
➤ ${prefix}chara search
➤ ${prefix}otaku search
➤ ${prefix}komiku search`
but = [
                { buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 },
                { buttonId: 's&k', buttonText: { displayText: 'S&K' }, type: 1 }
                 ]
...
➤ ${prefix}fdeface img link|teks1|teks2
➤ ${prefix}pantun
➤ ${prefix}memeindo
➤ ${prefix}darkjokes
➤ ${prefix}tospam  reply media|jumlah`
but = [
                { buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 },
                { buttonId: 's&k', buttonText: { displayText: 'S&K' }, type: 1 }
                 ]
...
➤ ${prefix}watercolor teks
➤ ${prefix}wonderfullgraffiti teks
➤ ${prefix}ssweb teks`
but = [
                { buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 },
                { buttonId: 's&k', buttonText: { displayText: 'S&K' }, type: 1 }
...
➤ ${prefix}bass reply audio
➤ ${prefix}gemuk reply audio
➤ ${prefix}detikvn audio and angka
➤ ${prefix}detikvideo video and angka
➤ ${prefix}sticker
➤ ${prefix}attp teks
➤ ${prefix}toimg
...
sendButLocation(from, menu, "Hai Halo User Felix!!", fakeimg, but, zer)
}
break
...
reply('𝐒𝐮𝐤𝐬𝐞𝐬 𝐌𝐞𝐧𝐠𝐚𝐤𝐭𝐢𝐟??𝐚𝐧 𝐖𝐞𝐥𝐜𝐨𝐦𝐞')
} else if (args[0] === 'off') {
...
zero.sendMessage(from, buff, image, {quoted: zer, caption: teks, thumbnail: Buffer.alloc(0)})
break
case 'antilink':
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins && !zer.key.fromMe) return reply(mess.only.admin);
...
but = [
                { buttonId: 'pussy', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Pussy Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
          case 'kemonomimi': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'kemonomimi', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Kemono Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'yuri': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'yuri', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Yuri Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'tits': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'tits', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Tits Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'holoeroi': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'holoeroi', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Holo Ero Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'holohentai': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'holohentai', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Holo Hentai Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'hololewd': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'hololewd', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Holo Lewd Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'fendom': {
reply(mess.wait)
...
let hasil3 = await getBuffer(v4.url)
but = [
                { buttonId: 'fendom', buttonText: { displayText: 'Try Again' }, type: 1 },
                 ]
sendButImage(from, 'Fetish +18 Random Img', "Klik Button Dibawah Untuk Melanjutkan", hasil3, but, zer)
}
break
case 'attp':
...
{buttonId: 'sc', buttonText: {displayText: 'SOURCE CODE'}, type: 1}
 ...
 buttons = {
contentText: 'Halo Kak!, Butuh Info Apa Dari Ownerku?\nJangan Sungkan Untuk Chat Ownerku Ya >_<',
footerText: faketeks,
buttons: button,
headerType: 1
}
await zero.sendMessage(from, buttons, MessageType.buttonsMessage)
break      
case 'report':
...
reply('Sukses bergabung kedalam group')
break
case 'readall':
                if (!isOwner && !zer.key.fromMe) return reply(mess.only.owner)
...
*TO DOWNLOAD*
🔖 ${prefix}ytmp3 linknya = Audio
🔖 ${prefix}ytmp4 linknya = Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"YOUTUBE SEARCH",mediaType:"2",thumbnail:fakethumb,mediaUrl:`https://youtu.be/SWowxFvdy_k`}}})
            } catch(e) {
...
await zero.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'NIH ASUPANNYA'})
break
case 'ytmp3':
if (args.length === 0) return reply(`Link Nya Mana ?\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
[ 1 ] DILARANG TELPON BOT!
[ 2 ] DILARANG SPAM BOT
[ 3 ] DILARANG EXPLOITASIKAN BOT
[ 4 ] DILARANG SPAM OWNER
[ 5 ] DILARANG TELPON OWNER

MOHON PATUHI RULESNYA`
var ZeroYT7 = {
            contextInfo: {
            participant: '0@s.whatsapp.net',
...
zero.sendMessage(from, anu, image, {quoted: ftrol, caption: 'Felix Chan V2' })
break
case 'hartatahta':
case 'naruto':
case 'bneon':
...
zero.sendMessage(from, res, image, {quoted: ftrol, caption: 'Felix Chan V2' })
break
case 'wolflogo':
case 'pubglogo':
case 'snowwrite':
...
zero.sendMessage(from, wll, image, {quoted: ftrol, caption: 'Felix Chan V2' })
break
case 'blackpink':
case 'neon':
case 'greenneon':
...
zero.sendMessage(from, blck, image, {quoted: ftrol, caption: 'Felix Chan V2' })
break
case 'memeindo':
reply(mess.wait)
coeg = await getBuffer(`https://api.lolhuman.xyz/api/meme/memeindo?apikey=${apikey1}`)
zero.sendMessage(from, coeg, image, {quoted: ftrol, caption: '...' })
break
case 'darkjokes':
reply(mess.wait)
coeg = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjokes?apikey=${apikey1}`)
zero.sendMessage(from, coeg, image, {quoted: ftrol, caption: '...' })
break
case 'ssweb':
...
zero.sendMessage(from, hasil, image, { thumbnail: Buffer.alloc(0), caption: `Felix Chan V2`, quoted : ftrol})
})
break
case 'asupan':
...
zero.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'NIH ASUPANNYA'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${apikey5}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zero.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'NIH ASUPANNYA'})
break
case 'asupanhijaber':
